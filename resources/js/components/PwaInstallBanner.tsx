        ...
        <div className="fixed bottom-0 left-0 right-0 bg-gray-800 text-white p-4 shadow-lg z-50 animate-slide-up">
            <div className="container mx-auto flex items-center justify-between gap-4">
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        <h4 className="font-bold">Zainstaluj aplikację</h4>
                        <p className="text-sm text-gray-300">Dodaj do ekranu głównego, aby uzyskać szybki dostęp.</p>
                    </div>
                </div>
                ...
                {deferredPrompt && !isIOS ? (
                    ...
                    <div className="text-xs text-center text-gray-400 p-2 border border-gray-600 rounded-md">
                        Kliknij <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline-block mx-1" viewBox="0 0 20 20" fill="currentColor"><path d="M15 8a3 3 0 10-2.977-2.63l-4.94 2.47a3 3 0 100 4.319l4.94 2.47a3 3 0 10.895-1.789l-4.94-2.47a3.027 3.027 0 000-.74l4.94-2.47C13.456 7.68 14.19 8 15 8z" /></svg> i "Dodaj do ekranu głównego"
                    </div>
                ) : null}
            </div>
            <style>{`
